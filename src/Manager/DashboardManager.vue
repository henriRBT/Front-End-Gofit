<template>
    <header class="navbar navbar-dark sticky-top flex-md-nowrap p-0 shadow" style="background-color: #00BFFF">
      <a class="navbar-brand col-md-2 col-lg-2 me-0 px-3" href="#">GOFIT Manager</a>
        ...
        <nav id="sidebarMenu" class="col-md-2 col-lg-2 d-md-block bg-light sidebar collapse">
          <div class="position-sticky pt-3">
            <ul class="nav flex-column">
              <li class="nav-item">
                <router-link :to="{ name: 'umum.index' }" class="nav-link">Jadwal Umum</router-link>
              </li>

              <li class="nav-item">
                <router-link :to="{ name: 'harian.index' }" class="nav-link">Jadwal Harian</router-link>
              </li>
